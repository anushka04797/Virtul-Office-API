...
class Department(models.Model):
    company_id = models.ForeignKey(Company, blank=False, null=False, on_delete=models.PROTECT)
    ...
    parrent = models.ForeignKey('self', null=True, blank=True, related_name='children', on_delete=models.PROTECT)
...
class Designation(models.Model):
    department_id = models.ForeignKey(Department, blank=False, null=False, on_delete=models.PROTECT)
...
class HolidayPlan(models.Model):
    ...
    week_start_day = models.CharField(_('Select week start day'), max_length=20, choices=WEEK_DAYS, default='Select', blank=False, null=False)
    weekholiday_1 = models.CharField(_('Select week holiday 1'), max_length=20, choices=WEEK_DAYS, default='Select', blank=False, null=False)
    weekholiday_2 = models.CharField(_('Select week holiday 2'), max_length=20, choices=WEEK_DAYS, default='Select', blank=False, null=True)
...
class Calender(models.Model):
    ...
    vacation_type = models.CharField(_('select vacation type'), max_length=20, choices=VACATION_TYPE, default='Select', blank=False, null=True)
    start_data = models.DateField(_('company\'s reserved holidays'), blank=True, null=True)
    end_date = models.DateField(_('company\'s reserved holidays'), blank=True, null=True)
...
class Slc(models.Model):
    employee_id = models.ForeignKey(CustomUser, blank=False, null=False, on_delete=models.PROTECT)
    department_id = models.ForeignKey(Department, blank=False, null=False, on_delete=models.PROTECT)
    designation_id = models.ForeignKey(Designation, blank=False, null=False, on_delete=models.PROTECT)
