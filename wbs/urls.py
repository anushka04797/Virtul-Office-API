...
from wbs.views import CreateWbs, WbsDetails, UpdateWbs, WbsListForEmployee, CreateTimeCard, TimeCardDetails, \
    ...
    UserWiseTimeCardList, AllWbsListForPm,AddTimeCard, UserWiseWeeklyTimeCardList, SubmitTimeCard,UploadWbsDocs,TimecardUpdate,UserSubmittedWeeklyTimecards, ConsumedHours
